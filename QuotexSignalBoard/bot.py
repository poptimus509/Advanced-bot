...
class DerivClient:
    ...
    def get_server_time(self):
        return max(self.server_time, int(time.time()))
        ...
        for job in jobs:
            ...
            try:
                ...
                if event.wait(timeout=3.0):
                    ...
                    results[key] = candles if candles else self._fetch_single_history(clean, count, granularity)
                else:
                    results[key] = self._fetch_single_history(clean, count, granularity)
        ...
        try:
            ...
            if msg_type == "ping":
                ...
                if req_id is not None and req_id in self._pending_requests:
                    self._request_results[req_id] = formatted
